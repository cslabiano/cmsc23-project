...
class AdminViewOrgDetails extends StatefulWidget {
  final String orgId;
  const AdminViewOrgDetails({required this.orgId, super.key});

  @override
  State<AdminViewOrgDetails> createState() => _AdminViewOrgDetailsState();
}

class _AdminViewOrgDetailsState extends State<AdminViewOrgDetails> {
  Org? organization;
  @override
  void initState() {
    super.initState();
