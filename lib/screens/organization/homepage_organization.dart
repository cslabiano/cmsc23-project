...
class _OrganizationHomepageState extends State<OrganizationHomepage> {
  final List<Donation> _donations = [
    Donation(category: "Monetary donation", forPickup: false, weight: 10, status: "Pending", donorName: "Myndie Labiano"),
    Donation(category: "Clothes donation", forPickup: false, weight: 10, status: "Pending", donorName: "Myndie Labiano"),
    Donation(category: "Other donation", forPickup: false, weight: 10, status: "Pending", donorName: "Myndie Labiano"),
    Donation(category: "Monetary donation", forPickup: false, weight: 10, status: "Pending", donorName: "Myndie Labiano"),
    Donation(category: "Monetary donation", forPickup: false, weight: 10, status: "Pending", donorName: "Myndie Labiano"),
    Donation(category: "Monetary donation", forPickup: false, weight: 10, status: "Pending", donorName: "Myndie Labiano"),
    Donation(category: "Monetary donation", forPickup: false, weight: 10, status: "Pending", donorName: "Myndie Labiano"),
